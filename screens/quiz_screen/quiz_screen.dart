...
import 'package:quiz_app/services/firestore_service.dart'; // Import FirestoreService

// You will need an AuthService or a way to get the current user's ID
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  int _currentIndex = 0;
  bool _isSubmitting = false; // State to handle loading indicator

  // Instantiate your services
  final FirestoreService _firestoreService = FirestoreService();
  // final AuthService _authService = AuthService(); // You'll need this
  ...
  // New function to handle saving quiz and navigating
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to save quiz: ${e.toString()}')),
        );
      }
    } finally {
      if (mounted) {
        ...
        actions: [
          Padding(
            ...
            child: ElevatedButton(
              ...
              // Updated child to show loading indicator
              child: _isSubmitting
                  ? const SizedBox(
                      width: 20,
                      height: 20,
